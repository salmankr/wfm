...
<div class="panel-body">
<h2 style="text-align: center;color: #6699ff;">Upload Report</h2>
<br>
<form class="form-inline text-center" action="upl_report.php" method="post" enctype="multipart/form-data">
<div class="form-group">
<div class="col-sm-4">
<input class="form-control" name="up_report" type="file" placeholder="Upload file" required="required">
</div>
</div>
<div class="form-group">
...
if(isset($_POST['upload'])){
	...
	$file_name = $_FILES['up_report']['name'];
	$tmp = $_FILES['up_report']['tmp_name'];
    $query = "INSERT INTO upload_report (file) VALUES ('$file_name')";
    $run = mysqli_query($con,$query);
    if($run){

    	 if(move_uploaded_file($tmp,"upload-server/reports/$file_name")){
