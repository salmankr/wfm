...
<div class="col-sm-9">
<div class="panel panel-default">
<div class="panel-heading">Swap Approval</div>
<div class="panel-body">
<?php
include("../db/connection.php");
$query = "SELECT * FROM swap LIMIT 0,1"; 
$run = mysqli_query($con,$query);
while($row = mysqli_fetch_array($run)){
	$f_emp = $row['emp_id1'];
	$f_name = $row['name1'];
	$f_sup = $row['supervisor1'];
	$swp_date = $row['swp_date'];
	$s_emp = $row['emp_id2'];
	$s_name = $row['name2'];
	$s_sup = $row['supervisor2'];
?>
<form class="form-horizontal" action="swap_apr.php" method="post" enctype="multipart/form-data">
...
<div class="col-sm-6">
<input type="text" class="form-control" name="f_emp" placeholder="ID" value="<?php echo $f_emp; ?>" readonly required="required">
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" name="f_name" placeholder="Name" value="<?php echo $f_name; ?>" readonly required="required">
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" name="f_sup" placeholder="Name" value="<?php echo $f_sup; ?>" readonly required="required">
</div>
</div>
...
<div class="col-sm-6">
<input type="date" class="form-control" name="date" placeholder="Date" value="<?php echo $swp_date; ?>" readonly required="required">
</div>
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" name="s_emp" placeholder="ID" value="<?php echo $s_emp; ?>" readonly required="required">
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" name="s_name" placeholder="Name" value="<?php echo $s_name; ?>" readonly required="required">
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" name="s_sup" placeholder="Name" value="<?php echo $s_sup; ?>" readonly required="required">
</div>
</div>
</div>
</form>
<div class="col-sm-offset-5 col-sm-6">
<button type="submit" name="swap_apr"  class="btn btn-default">Done</button>
</div>
<?php
}
include("../db/connection.php");
if(isset($_POST['swap_apr'])){
$emp_id = $_POST['f_emp'];
$swp_date=$_POST['date'];
$query = "DELETE FROM swap WHERE emp_id1 = '$emp_id' and swp_date = '$swp_date'";
$run = mysqli_query($con,$query);
if($run){
	?>
<div class="col-sm-12" style="text-align: center;"><b>Swap Approval/Disapproval Done!</b></div>
