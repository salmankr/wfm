...
<div class="col-sm-9">
<div class="panel panel-default">
<div class="panel-heading">Upload Roster</div>
<div class="panel-body">
<h2 style="text-align: center;color: #6699ff;">Upload Roster File</h2>
<br>
<form class="form-inline text-center" action="upl_rost.php" method="post" enctype="multipart/form-data">
<div class="form-group">
<div class="col-sm-4">
<input class="form-control" name="up_rost" type="file" placeholder="Upload file" required="required">
</div>
</div>
<div class="form-group">
<button type="upload" name="upload" class="btn btn-default">Upload</button>
</div>
</form>
<?php
include("../db/connection.php");
if(isset($_POST['upload'])){
	...
	$file_name = $_FILES['up_rost']['name'];
	$tmp = $_FILES['up_rost']['tmp_name'];
    $query = "INSERT INTO upload_rost (file_name) VALUES ('$file_name')";
    $run = mysqli_query($con,$query);
    if($run){

    	 if(move_uploaded_file($tmp,"upload-server/rosters/$file_name")){

              ?>
             <div class="alert alert-success alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <?php echo $file_name." Has Been Uploaded Successful!"; ?>
			 </div>
              <?php 
    	 }
    }
             ...
             <div class="alert alert-warning alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Warning!</strong> File Failed To Move.
			 </div>
              <?php 
    }
}
