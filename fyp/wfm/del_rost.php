...
<div class="col-sm-9">
<div class="panel panel-default">
<div class="panel-heading">Delete Roster</div>
<div class="panel-body">
<?php 
if(isset($_GET['del'])){
...
<thead>
<tr> 
<th> Roster Files </th> <th class="text-right"> Delete </th>
</tr>
<tbody> 
<?php 
include("../db/connection.php");
...
while($row = mysqli_fetch_array($run)){
     ...
     <td> <?php echo $id; ?> </td>
     <td> <a href="del_file.php?id=<?php echo $id; ?>" class="btn btn-default" style="float:right;">Delete</a> </td>
     </tr>
	 <?php 
}
?>
