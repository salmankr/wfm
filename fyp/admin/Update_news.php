...
<div class="panel-body">
<form class="form-horizontal" action="Update_news.php" method="post">

<div class="form-group">
<label for="update_news" class="col-sm-3 control-label">News</label>
<div class="col-sm-4">
<textarea rows="10" cols="50" class="form-control" name="news" id="show_num" required></textarea>
</div>
</div>
<p id="num" class="text-center"></p>
<div class="form-group">
<div class="col-sm-offset-2 col-sm-10">
<button type="submit" name="news_btn" class="btn btn-default">Update News</button>
</div>
</div>
<?php
include ("../db/connection.php");
    if(isset($_POST['news_btn'])){
    	$news = $_POST['news'];
        $query = "INSERT INTO news_feed (news) VALUES ('$news')";
        $run = mysqli_query($con,$query);
        if($run){
        	echo "<b>News updated</b>";
        }
		else{
