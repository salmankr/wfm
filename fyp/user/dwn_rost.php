...
<div class="panel-body">
<h2 style="text-align: center; color: #6699ff;">Download Latest Roster Here</h2>
<table class="table table-striped">
<thead>
<tr> 
<th> Roster Files </th> <th class="text-right"> Download </th>
</tr>
<tbody> 
<?php 
include("../db/connection.php");
$query = "SELECT * FROM upload_rost";
$run = mysqli_query($con,$query);
while($row = mysqli_fetch_array($run)){
     ...
     <td> <a href="dwn_file.php?id=<?php echo $id; ?>" class="btn btn-default" style="float:right;">Download</a> </td>
     </tr>
	 <?php 
}
?>
